...
impl<'a> DockerfileGenerator<'a> {
    ...
    pub fn new(config: &'a Config) -> Self {
        ...
        handlebars
            .register_template_string(
                "caddy_dockerfile",
                include_str!("../templates/Dockerfile.caddy.hbs"),
            )
        ...
        handlebars
            .register_template_string(
                "nginx_dockerfile",
                include_str!("../templates/Dockerfile.nginx.hbs"),
            )
        ...
        handlebars
            .register_template_string(
                "haproxy_dockerfile",
                include_str!("../templates/Dockerfile.haproxy.hbs"),
            )
        ...
        handlebars
            .register_template_string(
                "traefik_dockerfile",
                include_str!("../templates/Dockerfile.traefik.hbs"),
            )
    ...
    pub fn generate_for_proxy(&self, proxy: &ProxyConfig) -> Result<String> {
        match proxy.proxy_type.as_str() {
            ...
            _ => Err(crate::CerberusError::config(format!(
                "Unsupported proxy type for Dockerfile: {}",
                proxy.proxy_type
            ))),
        }
    }
    ...
    fn generate_haproxy_dockerfile(&self, proxy: &ProxyConfig) -> Result<String> {
        ...
        let dockerfile = self
            .handlebars
            .render("haproxy_dockerfile", &template_data)?;
        Ok(dockerfile)
    }
    ...
    fn generate_traefik_dockerfile(&self, proxy: &ProxyConfig) -> Result<String> {
        ...
        let dockerfile = self
            .handlebars
            .render("traefik_dockerfile", &template_data)?;
        Ok(dockerfile)
    }
